...
! (2) compile and run sequentially gen_grid.f90 and gen_xdmf.f90 
!     (see genview.sh)
! (3) visualize the flow with the output file viewfld_DNS_flow.xmf
!     e.g. with paraview: paraview viewfld_DNS_flow.xmf
! it assumes: 
